...
import { Button, InputItem, Text, PageLoading, Loading, View } from '@/common/components';
	...
	return (
		<div className="psl-page-content">
			<div className="psl-tel-wrap clearfix fix-content">
				<InputItem className="psl-tel" type="phone" placeholder="请输入手机号" value={mobile} />
			</div>
			<div className="flex-center-wrap flex-justify-content psl-code-getcode clearfix">
				<InputItem className="psl-code" type="phone" placeholder="请输入验证码" value={mobile} />

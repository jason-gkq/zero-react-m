let cache: any = [];
export function renderImage(ctx: any, medias: any, sheet: any, offset: any) {
...
function drawImage(ctx: any, index: any, data: any, position: any) {
  getImage(index, data)
    .then((image: any) => {
      let sx = 0;
      let sy = 0;
...
function getImage(index: any, data: any) {
